function [logli, dL, H] = Loss_GLM_logli(prs, processed)
...
for jch = 1:OPRS.nchunks
    ...
    Trm1 = sum(rr(intrialhi))*dt/RefreshRate;  % non-spike term
    if spflag, 
        Trm2 = -sum(log(rr(ii_sp & intrialhi))); % spike term
    else, Trm2 = 0;
    end    
