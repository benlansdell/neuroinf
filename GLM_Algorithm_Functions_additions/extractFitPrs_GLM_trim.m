function prs = extractFitPrs_GLM_trim(gg,Stim,MAXSIZE,processed, trim, pcas);
...
setupfitting_GLM_trim(gg,Stim,MAXSIZE,processed, trim, pcas);  % Precompute quantities for optimization
