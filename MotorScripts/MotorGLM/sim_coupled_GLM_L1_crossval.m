function sim_coupled_GLM_L1_crossval(wd, id, nRep, l, maxBins, fold, nfolds)
    ...
    load([wd '/all_units_network_L1_method_' method '_fold_' num2str(fold) '.mat']);
    rng('shuffle')
    time_limit = 2400;
    ...
    for ir = 1:nRep
        ...
        save([wd '/GLM_coupled_simulation_L1_method_' method '_lambda_' num2str(lambdas(l)) '_ID_' num2str(id) '_fold_' num2str(fold) '.mat'], 'Rt_glm', 'nRep', 'ir');
    end
end