function model = MLE_SD_grouplasso(data, lambda, const)
	...
	%Fit GLm
	[b, dev] = glmfit_SD_grouplasso(data.X,data.y(1,:), const, b0, nC, cplidx, lambda);
...
function [b, dev] = glmfit_SD_grouplasso(X, y, const, b0, nC, cplidx, lambda)
