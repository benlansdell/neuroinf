function data = filters_monkey_sp_stmrev(processed, nK_sp, nK_stm, dt_sp, dt_stm)
	...
	data.k{1,3} = dt_sp;
	data.k{2,1} = 'curs x';
	data.k{2,2} = (1:(nKs)) + nK_sp;
	data.k{2,3} = dt_stm;
	data.k{3,1} = 'curs y';
	data.k{3,2} = (1:(nKs)) + nK_sp + nKs;
	data.k{3,3} = dt_stm;
	data.k{4,1} = 'curs z';
	data.k{4,2} = (1:(nKs)) + nK_sp + 2*nKs;
	data.k{4,3} = dt_stm;
	data.k{5,1} = 'grip';
	data.k{5,2} = (1:(nKs)) + nK_sp + 3*nKs;
	data.k{5,3} = dt_stm;
