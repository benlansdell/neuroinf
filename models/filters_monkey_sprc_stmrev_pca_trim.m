function data = filters_monkey_sprc_stm_pca_trim(processed, nK_sp, nK_stm, a, dt_sp, dt_stm)
	%Prepare spike and stimulus data for GLM
	%
	%Usage:
	%	data = filters_monkey_sp_stm_pca_trim(processed, nK_sp, nK_stm)
	%     
	%Input:
	...
	%	data = filters_monkey_sprc_stm_pca_trim(processed, nK_sp, nK_stm, a, dt_sp, dt_stm);
