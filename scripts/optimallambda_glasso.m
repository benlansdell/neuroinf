...
fn_out = './optimallambda_glasso.eps';
...
for l = 1:length(lambdas)
	...
	for idx = 1:length(responsefiles)
		...
		data = filters_sp_stm_network(training, nK_sp, nK_stm);
		models{l,idx} = MLE_SD_grouplasso(data, lambda, const);
...
save('./run_optimallambda_glasso.mat', 'models', 'data', 'processed')
