...
nB = size(proc.stim, 1);
fn_out = './PCAfilters_stim_gaussbasis.eps';
...
tend = 12000;
unit = 6;
fn_out = ['./results/Uncoupled_GLM_cell_' num2str(unit) '.eps'];
load(['./results/Uncoupled_GLM_cell_' num2str(unit) '.mat'],'gg','Rt_glm');
tidx = tstart:tend;
truesp = proc_withheld.spiketrain(tidx,unit);
