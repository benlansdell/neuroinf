...
models = {};
nRep = 20;
fn_out = './monkeyresults2/run6_glm_fitting_sp_100Hz_fwdrev_trim_80pt.eps';
...
%save('./monkeyresults2/run6_glm_fitting_sp_100Hz_forwardback_trim_80pt.mat', 'models', 'data', 'processed', 'simtrains', 'nRep')
save('./monkeyresults2/run6_glm_fitting_sp_100Hz_forwardback_trim_80pt.mat', 'models', 'data', 'processed')