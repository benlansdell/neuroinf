...
%1 Preprocess data%
%%%%%%%%%%%%%%%%%%%
goodunits = [4,6,7,8,9,14,15,16,17,20,23,31,34,35,36,37,39,40,41];
...
nB = size(proc.stim, 1);
fn_out = './results3_gauss_move_5hz_maxit20_1frame_refract_notrim/';
trim = 0;
pca = 0;
Dt = 20;
maxit = 20;
...
for icell = goodunits
    ...
    for ir = 1:nRep
        ir
        [iR_glm,vmem,Ispk] = simGLM_monkey(gg, stim, time_limit, offset);
