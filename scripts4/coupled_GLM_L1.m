...
saveplot(gcf, [fn_out '/GLM_coupled_L1_lambda.eps'])

%Plot filters
for l = 1:(length(lambdas)-2)
    plot_filters_network_compare(ggs_cpl(l,:), ggs_cpl(length(lambdas),:), proc, [fn_out '/network_filters_compare_lambda_' num2str(lambdas(l)) '.eps'], 1:nU);
end
