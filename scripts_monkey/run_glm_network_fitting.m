...
const = 'on';
models = {};
fn_out = './monkeyresults/run_glm_fitting_sp_network.eps';
...
plot_filters_network_monkey(models, data, processed, fn_out);

%Save models, and other data
data = rmfield(data, {'X', 'y'});
processed = rmfield(processed, {'cursor', 'grip', 'spikes'});
save('./monkeyresults/run_glm_fitting_sp_network.mat', 'models', 'data', 'processed')
