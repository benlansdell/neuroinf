...
models = {};
nRep = 20;
fn_out = './monkeyresults2/run2_glm_fitting_sp_5Hz_fwdrev_80pt.eps';
...
for idx = 1:nU
	...
	data = filters_monkey_sprc_stmrev(processed, nK_sp, nK_stm, a, dt_sp, dt_stm);
...
%save('./monkeyresults2/run2_glm_fitting_sp_5Hz_forwardback_80pt.mat', 'models', 'data', 'processed', 'simtrains', 'nRep')
save('./monkeyresults2/run2_glm_fitting_sp_5Hz_forwardback_80pt.mat', 'models', 'data', 'processed')